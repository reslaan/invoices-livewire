    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            {{-- <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('post')">
                        {{ __('Post') }}
                    </x-nav-link>
                </div>
            </div> --}}
            ...
            <!-- Settings Dropdown -->
            <div class="hidden  sm:flex sm:items-center space-x-2 rtl:space-x-reverse ltr:sm:ml-6 rtl:sm:mr-6">
                <x-button.primary>Arabic</x-button.primary>
