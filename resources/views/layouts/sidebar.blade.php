<aside :class="openSide ? 'w-64 ' : 'w-20'"
    class="fixed  transition-all  z-20  duration-500  min-h-screen  bg-gray-900 text-white">
    <div class="px-6 pt-8">
        <div class="flex items-center justify-between">
            <a href="#" class="flex items-center justify-center rounded bg-primary p-1.5 px-2"><i
                    class="bi-layers"></i></a>
            <button x-on:click="openSide = !openSide" :class="!openSide ? 'rotate-180 ml-3' : ''" id="sidebarBtn"
        ...
        <ul class="flex flex-col space-y-2 text-gray-500">
            <x-sidebar.item>
                <x-sidebar.link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                    <i class="bi-hdd-stack pr-1"></i> <span x-show="openSide">{{ __('Dashboard') }}</span>
                </x-sidebar.link>
            </x-sidebar.item>
            ...
            <x-sidebar.item>
                <x-sidebar.link href="#"><i class="bi-bag pr-1"></i> <span x-show="openSide">Market & sell</span>
                </x-sidebar.link>
            </x-sidebar.item>
            <x-sidebar.item>
                <x-sidebar.link href="#"><i class="bi-bar-chart-fill"></i> <span
