...
<div class="alert pt-10 fixed inset-0 z-10  flex justify-center items-top">
    <div class="relative overflow-hidden transition ease-out duration-300 bg-warning  shadow  rounded-lg w-1/2  sm:w-1/3 h-16  py-5 px-6 mb-3 font-bold text-base text-white inline-flex items-center "
        role="alert">

        <x-icon.info></x-icon.info>
